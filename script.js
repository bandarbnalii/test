    ...
    function type() {
        if (i < text.length) {
            ...
            if (text.substring(i, i + 6) === '<span ') {
                // Find the complete span tag
                let tagEnd = text.indexOf('>', i) + 1;
                let spanContent = text.substring(i, tagEnd);
...
document.addEventListener('DOMContentLoaded', function() {
    const animateElements = document.querySelectorAll('.service-card, .feature-card, .solution-item, .portfolio-item');
